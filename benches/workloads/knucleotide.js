// knucleotide.js — must match knucleotide/main.rut: the identical
// k-mer counting on `new Map()` with string keys. The sequence is
// generated with fasta's LCG (the harness takes no stdin — the same
// adaptation both sides). Scale: seq = 200000 letters.
