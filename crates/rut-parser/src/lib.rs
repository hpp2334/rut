...
pub fn is_reserved_kw(s: &str) -> bool {
    matches!(s, "let" | "mut" | "if" | "else" | "while" | "for" | "of" | "return" | "when" | "enum" | "class" | "struct" | "interface" | "impl" | "requires" | "import" | "pub" | "from" | "static" | "suspend" | "async" | "await" | "extern" | "where" | "is" | "host" | "fn" | "true" | "false" | "nil" | "select")
}
