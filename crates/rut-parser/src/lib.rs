...
pub fn is_reserved_kw(s: &str) -> bool {
    matches!(s, "let" | "mut" | "if" | "else" | "while" | "for" | "of" | "return" | "when" | "enum" | "class" | "dataclass" | "trait" | "impl" | "requires" | "import" | "pub" | "from" | "static" | "suspend" | "await" | "extern" | "where" | "dyn" | "type" | "is" | "host" | "fn" | "true" | "false" | "select")
}
