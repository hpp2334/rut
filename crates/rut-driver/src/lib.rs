...
fn op_str(op: &Op) -> String {
    match op {
        ...
        Op::EqI { dst, a, b } => format!("eqi r{dst}, r{a}, r{b}"),
        Op::NeI { dst, a, b } => format!("nei r{dst}, r{a}, r{b}"),
        Op::LtI { dst, a, b } => format!("lti r{dst}, r{a}, r{b}"),
        Op::GtI { dst, a, b } => format!("gti r{dst}, r{a}, r{b}"),
        Op::LeI { dst, a, b } => format!("lei r{dst}, r{a}, r{b}"),
        Op::GeI { dst, a, b } => format!("gei r{dst}, r{a}, r{b}"),
